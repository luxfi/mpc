...
// envelope→enrollment binding was weak (e.g. SecureGate has not yet shipped
...
func (s *Server) handleBiometricEnroll(w http.ResponseWriter, r *http.Request) {
	...
	// bind to. SecureGate signs these into the attestation so a stolen
	...
	// the SecureGate rollout window by setting MPC_LIVENESS_BINDING=lax.
