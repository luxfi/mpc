  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="mt-12 rounded-xl border border-border bg-card p-6">
        ...
        <code className="rounded bg-background px-3 py-1.5 text-sm text-foreground">
          https://mpc-api.lux.network/api/v1
        </code>
        <p className="mt-3 text-sm text-muted-foreground">
          Authenticate with JWT (via Lux ID / Pars ID / Zoo ID) or API keys.
          All endpoints require the <code className="text-foreground">Authorization: Bearer &lt;token&gt;</code> header
          or <code className="text-foreground">X-API-Key: &lt;key&gt;</code> header.
        </p>
      </div>
