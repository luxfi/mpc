const statusColors: Record<string, string> = {
  ...
  co_signed: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  pending: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  pending_approval: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  pending_sign: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  ...
  hsm_signing: 'bg-blue-500/10 text-blue-400 border-blue-500/20',
